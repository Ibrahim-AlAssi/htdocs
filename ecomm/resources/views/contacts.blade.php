...
<div class="row-fluid">
    ...
    <div class="span4">
    <h4>Email Us</h4>
    <form class="form-horizontal" action="/postcontacts" method="POST">
        @csrf
    <fieldset>
      <div class="control-group">
       
          <input type="hidden" name="id" class="input-xlarge" value="{{ Auth::user()->id }}"/>
       
      </div>
       
       <div class="control-group">
       
          <input type="text" name="title" placeholder="subject" class="input-xlarge"/>
      
      </div>
      <div class="control-group">
          <textarea rows="3" name="subject"  class="input-xlarge"></textarea>
